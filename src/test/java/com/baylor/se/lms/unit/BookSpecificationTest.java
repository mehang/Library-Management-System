...
public class BookSpecificationTest {
    ...
    public void testUniqueISBN() {
        ...
        bookSpecification.setIsbn("121");
        bookSpecification.setLanguage("En");
        bookSpecification.setEdition("3rd");
        bookSpecificationRepository.save(bookSpecification);

        BookSpecification bookSpecification1 =  new BookSpecification();
        bookSpecification1.setName("Test Book2");
        bookSpecification1.setIsbn("121"); //  Not Unique
        bookSpecification1.setLanguage("En");
        bookSpecification1.setEdition("3rd");
        bookSpecificationRepository.save(bookSpecification1);
        List<BookSpecification> bookSpecificationList = (List<BookSpecification>) bookSpecificationRepository.findAll();
        if(bookSpecificationList.contains(bookSpecification1)) fail("Should not be saved");
    }
