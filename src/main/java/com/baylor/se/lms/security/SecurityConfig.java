...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().
                ...
                .antMatchers(HttpMethod.POST, "/books/request").hasRole("STUDENT")
                .antMatchers(HttpMethod.GET, "/books/search").permitAll()
                .antMatchers(HttpMethod.POST, "/books/increase").hasRole("LIBRARIAN")
                .antMatchers(HttpMethod.POST, "/books/issue").hasRole("LIBRARIAN")
                .antMatchers(HttpMethod.POST, "/books/return").hasRole("LIBRARIAN")
